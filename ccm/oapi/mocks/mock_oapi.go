...
// Source: github.com/outscale/cloud-provider-osc/ccm/oapi (interfaces: OAPI)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=./ccm/oapi/mocks/mock_oapi.go github.com/outscale/cloud-provider-osc/ccm/oapi OAPI
//
