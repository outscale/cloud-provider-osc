...
type FCU interface {
	...
	ReadVms(*osc.ReadVmsOpts) ([]osc.Vm, *_nethttp.Response, error)
	ReadSecurityGroups(*osc.ReadSecurityGroupsOpts) ([]osc.SecurityGroup, *_nethttp.Response, error)

    CreateSecurityGroup(*osc.CreateSecurityGroupOpts) (osc.CreateSecurityGroupResponse, *_nethttp.Response, error)
    DeleteSecurityGroup(*osc.DeleteSecurityGroupOpts) (osc.DeleteSecurityGroupResponse, *_nethttp.Response, error)

    CreateSecurityGroupRule(*osc.CreateSecurityGroupRuleOpts) (osc.CreateSecurityGroupRuleResponse, *_nethttp.Response, error)
    DeleteSecurityGroupRule(*osc.DeleteSecurityGroupRuleOpts) (osc.DeleteSecurityGroupRuleResponse, *_nethttp.Response, error)

    ReadSubnets(*osc.ReadSubnetsOpts) ([]osc.Subnet, *_nethttp.Response, error)

    CreateTags(*osc.CreateTagsOpts) (osc.CreateTagsResponse, *_nethttp.Response, error)

    ReadRouteTables(*osc.ReadRouteTablesOpts) ([]osc.RouteTable, *_nethttp.Response, error)
    CreateRoute(*osc.CreateRouteOpts) (osc.CreateRouteResponse, *_nethttp.Response, error)
    DeleteRoute(*osc.DeleteRouteOpts) (osc.DeleteRouteResponse, *_nethttp.Response, error)

    UpdateVm(*osc.UpdateVmOpts) (osc.UpdateVmResponse, *_nethttp.Response, error)

    ReadNets(*osc.ReadNetsOpts) (osc.ReadNetsResponse, *_nethttp.Response, error)
}
