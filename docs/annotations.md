...
| service.beta.kubernetes.io/osc-load-balancer-ingress-ipmode | n/a | Yes | Defines what information is set in `status.loadBalancer.ingress.ipMode `: `Proxy` or `VIP`.
