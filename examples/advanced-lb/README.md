...
This example creates a deployment named echoheaders on your cluster, listening on port 8080 (http) and 8443 (https), exposed through a HTTPS service.

> This examples requires that you have a SSL certificate. Read [the documentation about certificates](https://docs.outscale.com/en/userguide/Uploading-a-Server-Certificate.html) to learn how to upload a certificate.
...
- Ensure that the LB was created and the endpoint is available
```sh	
